...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_v68ydcm', 'template_zxvuwqv', form.current, 'CYPsshzxDffbHp7tJ')
      .then(
        (result) => {
                  ...
                  <div className="row">
                    <div className="row">
                      <h6>
                        ...
                        <a className="btn btn-facebook" href="https://github.com/" rel="noreferrer" target="_blank">
